...
var ExprotBox2Dialog = /** @class */ (function (_super) {
    ...
    ExprotBox2Dialog.prototype.screenAdaptation = function () {
        ...
        if (GameData_1.default.DcSj3) {
            ...
            LocalStorageUtil_1.default.setBoolean(ConfigData_1.LocalStorageKey.DcSj3, true);
        }
        // let _bannerTime = 1000;
        // if(ConfigData.IsMisLead){
        //     this.btnNext.visible = true;
        //     Laya.timer.once(_bannerTime,this,()=>{
        //         this.showBottomBanner()
        //      })
        //      Laya.timer.once(4000,this,()=>{
        //         AdMg.Instance.hideBanner();
        //       })
        // }else{
    ...
    ExprotBox2Dialog.prototype.onClick = function (e) {
        ...
        switch (e.target.name) {
            ...
            case 'retrunHome':
                //返回
                // UmMg.trackEvent('e_48');
                // Laya.Dialog.open(ActivityUrls.EXPROTLIST_DIALOG,false)
                break;
            default:
                break;
        }
